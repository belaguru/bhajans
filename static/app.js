...
${bhajan.lyrics.split('\n').map(line => line.trimStart()).join('\n')}
    ...
    renderShareButtons(bhajan) { 
        return `<div class="share-button-group">
            <button class="share-button-icon download-btn" onclick="app.downloadBhajan('${bhajan.title.replace(/'/g, "\'")}', '${bhajan.lyrics.replace(/'/g, "\'").substring(0,100)}...')">
                <span class="icon">📥</span>
                <span class="label">Download</span>
            </button>
            <button class="share-button-icon whatsapp-btn" onclick="app.shareWhatsApp('${bhajan.title.replace(/'/g, "\'")}')">
            ...
            <button class="share-button-icon telegram-btn" onclick="app.shareTelegram('${bhajan.title.replace(/'/g, "\'")}')">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <button class="share-button-icon copy-btn" onclick="app.copyLink('${bhajan.id}')">
                <span class="icon">🔗</span>
